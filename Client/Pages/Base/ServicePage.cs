...
using MagicT.Client.Pages.Audits;
...
public abstract class ServicePage<TModel, TService> : PageBaseClass
...
/// <typeparam name="TService">The type of the service.</typeparam>
public abstract class ServicePage<TModel, TChild, TService> : ServicePage<TChild, TService>
