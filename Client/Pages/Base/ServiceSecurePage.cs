...
namespace MagicT.Client.Pages.Base;
...
public abstract class ServiceSecurePage<TModel, TService> : ServicePage<TModel, TService>
...
/// <typeparam name="TService">The type of the service.</typeparam>
public abstract class ServiceSecurePage<TModel, TChild, TService> : ServiceSecurePage<TChild, TService>
